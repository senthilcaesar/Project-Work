...
from crater_deep_network import sigmoid, tanh, ReLU, Network
from crater_deep_network import ConvPoolLayer, FullyConnectedLayer, SoftmaxLayer

training_data, validation_data, test_data = crater_deep_network.load_data_shared()
mini_batch_size = 10
